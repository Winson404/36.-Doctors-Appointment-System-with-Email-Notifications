  ...
  <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel" >
    ...
    <div class="carousel-inner" role="listbox" >
      ...
      <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);" >
          <div class="container" >
              <h2>Welcome to <span>CCP CLINIC APPOINTMENT</span></h2>
...
<section id="about" class="about">
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-title">
      <h2>About Us</h2>
      <p>Welcome to CCP Clinic Appointment, where your health is our priority. Our mission is to provide seamless and efficient appointment services to ensure you receive the care you need when you need it. Learn more about our commitment to excellence, patient-centric approach, and the dedicated team behind CCP Clinic Appointment. Your well-being is at the heart of what we do, and we look forward to serving you with the highest standard of care.</p>
    </div>

    <div class="row">
      <div class="col-lg-6" data-aos="fade-right">
        <img src="assets/img/school.jpg" class="img-fluid" alt="Centralians Clinic Building">
      </div>
      <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
        <h3>Experience Quality Healthcare at CCP Clinic Appointment</h3>
        ...
        <ul>
          <li><i class="bi bi-check-circle"></i> Unparalleled commitment to patient care and satisfaction.</li>
          <li><i class="bi bi-check-circle"></i> Expert doctors providing personalized medical services.</li>
          <li><i class="bi bi-check-circle"></i> State-of-the-art facilities for comprehensive healthcare.</li>
        </ul>
        <p>At CCP Clinic Appointment, we strive to create a welcoming and healing environment for our patients. Our dedicated team works tirelessly to ensure your health and well-being are prioritized. Experience the difference with CCP Clinic Appointment - where your health matters the most.</p>
      </div>
    </div>
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-6">
        <form action="processes.php" method="post" class="info-box p-3">
          ...
          <div class="text-center"><button class="btn btn-primary mt-3" type="submit" name="sendEmail" style="background-color: #FFD700; border: none;">Send Message</button></div>
        </form>
      </div>
